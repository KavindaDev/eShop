...
// get products with filters or without filters
...
//post new prudict using category id
...
router.put(`/:id`, uploadOptions.single('image'), async (req, res) => {
    ...
    //taking specific image file with product id
    const product = await Product.findById(req.params.id)
...
router.get(`/get/count`, async (req, res) => {
    ...
    if (!productCount) {
        res.status(400).json({ success: false, message: "No Products not found!!" })
    }
    res.send({
